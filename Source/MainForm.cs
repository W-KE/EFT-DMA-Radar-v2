...
namespace eft_dma_radar
{
    public partial class frmMain : MaterialForm
    {
            ...
            if (aimviewPlayers is not null)
            {
                foreach (var player in aimviewPlayers)
                {
                    ...
                    if (this.ShouldDrawPlayer(myPosition, player.Position, this.config.MaxDistance))
                        this.DrawAimViewPlayer(canvas, drawingLocation, myPosition, player, myRotation);
                }
            }
        ...
        {
            canvas.DrawLine(
                drawingLocation.Left + (drawingLocation.Width / 2) - (this.aimviewWindowSize / 2),
            ...
            canvas.DrawLine(
                ...
                drawingLocation.Top + (drawingLocation.Height / 2) - (this.aimviewWindowSize / 2),
                drawingLocation.Left + (drawingLocation.Width / 2),
                drawingLocation.Top + (drawingLocation.Height / 2) + (this.aimviewWindowSize / 2),
                SKPaints.PaintAimviewCrosshair
            );
        ...
        private void DrawAimViewPlayer(SKCanvas canvas, SKRect drawingLocation, Vector3 myPosition, Player player, Vector2 myRotation)
        {
            ...
            float angleY = this.CalculateAngleY(heightDiff, dist, -myRotation.Y);
            ...
            float angleX = this.CalculateAngleX(opposite, adjacent, NormalizeDirection(myRotation.X));
        ...
        private void swMasterSwitch_CheckedChanged(object sender, EventArgs e)
        {
            ...
            // this.config.MasterSwitch = isChecked; disable write
